...
<html xmlns:h="http://xmlns.jcp.org/jsf/html" xmlns:f="http://xmlns.jcp.org/jsf/core">
    <head>
        ...
        <%
            ...
            if(LoginController.loginCheck(username,password))
            {
                newsList = TimelineController.getEdittedNewsList();
                pageContext.setAttribute("newsList", newsList);
            }
            else
                response.sendRedirect("/NMSPegasusNews/");
        %>
    ...
    <body>
                ...
                <c:forEach var="news" items= "${pageScope.newsList}" varStatus="count">
                    <c:if test="${count.index%2==0}">
                        <li>
                            <div class="timeline-badge primary">
                                <a><i class="glyphicon glyphicon-record" rel="tooltip" title="<c:out value="published date and time"/>" id=""></i></a>
                            </div>
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-footer">
                                    <a><span><i class="glyphicon glyphicon-time" ></i> published date and time </span></a>
                    ...
                    <c:if test="${count.index%2==1}">
                        <li  class="timeline-inverted">
                            <div class="timeline-badge primary"><a><i class="glyphicon glyphicon-record invert" rel="tooltip" title="<c:out value="published date and time"/>" id=""></i></a></div>
                            <div class="timeline-panel">
                                <div class="timeline-footer">
                                    <h4><c:out value="${news.getTitle()}"/></h4>
                                </div>
            ...
            <div class="modal fade" id="newsModal${newsCount.index}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class= "col-md-12">
                                <span><i class="glyphicon glyphicon-calendar"></i> published date </span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class = "raw">
                ...
                <div class = "col-md-4">
                    <button class="btn btn-success center-block" >Logged</button>
                </div>
